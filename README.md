...
ConvertCN 是一个专门解决中文编码问题的现代化工具，帮助开发者快速统一项目中的文件的中文编码格式。

### 主要用途

**🔧 解决开发中的编码痛点**
- 在 Source Insight 等IDE中查看代码时，中文注释显示乱码
- 团队协作时文件中的中文编码格式不统一（GBK、UTF-8、GB2312混杂）
- 接手老项目时需要批量转换中文编码格式
- 开源项目本地化时需要处理各种中文编码的文档

**📁 批量文件处理**
- 一键扫描整个项目目录，自动识别所有文件的中文编码格式
- 批量转换 C/C++、Python、Java 等源代码文件的中文编码
- 支持处理配置文件、文档文件、日志文件等多种格式
- 智能过滤文件类型，只处理需要的文件

**📋 典型使用场景**
- **ESP32/Arduino项目**：统一几十上百个 .c/.h 文件的不同中文编码格式
- **Python项目维护**：将老项目从 GBK 批量转换为 UTF-8
- **技术文档整理**：统一处理混合的中文编码的 .txt、.md、.doc 文档
- **代码审查准备**：确保提交的代码文件的中文编码格式一致

### 核心功能

- ✅ **智能编码检测**：自动识别文件中的中文编码，无需手动指定
